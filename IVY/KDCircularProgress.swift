   ...
   // override
    ...
    fileprivate class KDCircularProgressViewLayer: CALayer {
        ...
        override func draw(in ctx: CGContext) {
            ...
            let centerCtx = CGPoint(x: CGFloat(size.width/2.0),y: CGFloat(size.height/2.0))
            
           // CGContext.addArc(ctx, CGFloat(size.width/2.0), CGFloat(size.height/2.0), arcRadius, 0, CGFloat(M_PI * 2), 0)
            ctx.addArc(center: centerCtx, radius: arcRadius, startAngle: 0, endAngle: CGFloat(M_PI * 2), clockwise: false)
            ...
            let centerImgCtx = CGPoint(x: CGFloat(size.width/2.0), y: CGFloat(size.height/2.0))
...
//            CGContextAddArc(imageCtx, CGFloat(size.width/2.0),CGFloat(size.height/2.0), arcRadius, fromAngle, toAngle, clockwise == true ? 1 : 0)
            ...
            imageCtx?.addArc(center: centerImgCtx, radius: arcRadius, startAngle: fromAngle, endAngle: toAngle, clockwise: clockwise == true ? true : false)

//            CGContext.addArc(imageCtx)

//            CGContext.addArc(imageCtx, centerCtx, arcRadius, fromAngle, toAngle, clockwise == true)
